        ...
        !(function (e, n) {
            ...
            function L(t, e, n, i) {
                ...
                if (
                    ...
                    if (l)
                        for (
                            c = a[a.length - 1].ownerDocument, yt.map(a, j), f = 0; f < l; f++
                        )
                            (u = a[f]),
                            Qt.test(u.type || "") &&
                ...
                return (
                    ...
                    (S = e.select = function (t, e, n, i) {
                        ...
                        if (((n = n || []), 1 === p.length)) {
                            ...
                            for (
                                o = ft.needsContext.test(t) ? 0 : r.length; o-- && ((s = r[o]), !w.relative[(a = s.type)]);
            ...
            ((yt.fn.init = function (t, e, n) {
                ...
                if (((n = n || Nt), "string" == typeof t)) {
                    if (
                        !(i =
                            "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] :
                            At.exec(t)) ||
                        (!i[1] && e)
                    )
                        return !e || e.jquery ?
            ...
            yt.extend({
                ...
                yt.fn.extend({
                    ...
                    promise: function (t, e) {
                        ...
                        for (
                            "string" != typeof t && ((e = t), (t = void 0)), t = t || "fx"; s--;
            ...
            yt.extend({
                    ...
                    clone: function (t, e, n) {
                        ...
                        if (e)
                            if (n)
                                for (
                                    r = r || T(t), s = s || T(a), i = 0, o = r.length; i < o; i++
                                )
                                    O(r[i], s[i]);
                            else O(t, a);
                        return (
                    ...
                    cleanData: function (t) {
                        for (
                            var e, n, i, o = yt.event.special, r = 0; void 0 !== (n = t[r]); r++
                        )
                            if (Pt(n)) {
                                if ((e = n[Ht.expando])) {
                                    if (e.events)
                ...
                yt.each({
                    ...
                    function (t, e) {
                        yt.fn[t] = function (t) {
                            for (
                                var n, i = [], o = yt(t), r = o.length - 1, s = 0; s <= r; s++
                            )
                ...
                yt.extend({
                    valHooks: {
                        ...
                        select: {
                            ...
                            set: function (t, e) {
                                for (
                                    var n, i, o = t.options, r = yt.makeArray(e), s = o.length; s--;
                    ...
                    trigger: function (t, e, i, o) {
                        ...
                        if (
                            ...
                            if (!o && !f.noBubble && !yt.isWindow(i)) {
                                for (
                                    l = f.delegateType || d, Se.test(l + d) || (s = s.parentNode); s; s = s.parentNode
                                )
                                    p.push(s), (a = s);
            ...
            yt.ajaxSetup({
                ...
                yt.fn.extend({
                    ...
                    offsetParent: function () {
                        return this.map(function () {
                            for (
                                var t = this.offsetParent; t && "static" === yt.css(t, "position");
